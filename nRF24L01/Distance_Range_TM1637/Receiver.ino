//ВАЖНО ИСПОЛЬЗОВАТЬ БИБЛИОТЕКУ ВЕРСИИ TM1637-1.1.0 для отображения полученных пакетов. Иначе дисплей не будет включаться
...
void setup() {
  ...
  radio.setChannel(0x6b);   // выбираем канал (в котором нет шумов!)
